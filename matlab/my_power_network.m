...
delay_duration = 60;
opt.sim.uvls_tdelay_ini = delay_duration;  % 1 sec delay for uvls relay.
opt.sim.ufls_tdelay_ini = delay_duration;  % 1 sec delay for ufls relay.
opt.sim.dist_tdelay_ini = delay_duration;  % 1 sec delay for dist relay.
opt.sim.temp_tdelay_ini = delay_duration;    % 0 sec delay for temp relay.
